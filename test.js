...
QUnit.test('calculate()', function(assert) {
    assert.throws(function () { calculate(-1,-1,-1); },0, 'Enter the Positive Inputs properly');
   assert.throws(function () { calculate(0,0,0); },0, 'Enter the Inputs properly');
    assert.throws(function () { calculate("Christine","Christine","Christine"); },NaN, 'Passing in a string correctly raises an Error');
